...
CREATE TABLE `blog_comments` (
  ...
  `comment_admin` varchar(10) NOT NULL,
  `content` varchar(100) NOT NULL,
  `sending_time` datetime DEFAULT NULL,
  PRIMARY KEY (`comment_id`),
  KEY `blog_id_idx` (`blog_id`,`comment_admin`),
  KEY `admin_idx` (`comment_admin`),
  CONSTRAINT `blog_id` FOREIGN KEY (`blog_id`) REFERENCES `blog` (`blog_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `comment_admin` FOREIGN KEY (`comment_admin`) REFERENCES `admin_infor` (`admin`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-12-08 20:35:01
